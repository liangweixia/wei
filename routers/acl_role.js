...
router.get('/allow',function(req,res){
    var arg = {"role":"5aa22c667af16a3aa8f6689c",
               "resources":["5aa22e167af16a3aa8f668ae","5aa22e4d7af16a3aa8f668b0","5aa22e647af16a3aa8f668b2"]};
    async.auto({
        resources:function(cb) {
            resourceController.getList({},function(err,resources){
        ...
        add:["remove",function(data,cb) {
            global.acl.allow(arg.role,arg.resources,'*',function(err){
                cb(err)
            })
        }],
    },function(err,result){
